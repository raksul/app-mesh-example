...
var file_echo_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x65, 0x63, 0x68, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x2e, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x22, 0x21, 0x0a, 0x0b, 0x45,
	...
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x50, 0x0a, 0x0b, 0x45, 0x63, 0x68, 0x6f,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x41, 0x0a, 0x04, 0x45, 0x63, 0x68, 0x6f, 0x12,
	0x1a, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2e,
	0x45, 0x63, 0x68, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1b, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x2e, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x45, 0x63, 0x68, 0x6f,
...
var file_echo_proto_goTypes = []interface{}{
	(*EchoRequest)(nil),  // 0: proto.example.EchoRequest
	(*EchoResponse)(nil), // 1: proto.example.EchoResponse
}
var file_echo_proto_depIdxs = []int32{
	0, // 0: proto.example.EchoService.Echo:input_type -> proto.example.EchoRequest
	1, // 1: proto.example.EchoService.Echo:output_type -> proto.example.EchoResponse
...
func (c *echoServiceClient) Echo(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (*EchoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.example.EchoService/Echo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _EchoService_Echo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.example.EchoService/Echo",
	}
...
var _EchoService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "proto.example.EchoService",
